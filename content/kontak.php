...
<a class="nav-link" href="../index.html"> Beranda </a>
        ...
        <img draggable="true" src="../gambar/faith.jpg" class="mx-auto d-block img-fluid">

        <!-- Contact Card -->
        <div class="bg-white rounded shadow p-4 mx-auto my-5" style="width: 68%; color: black;">
            <h3 class="fw-bold mb-4">Kontak dan Informasi GPPIK Bukit Zaitun</h3>
            <p><i class="bi bi-telephone-fill me-2"></i>Kontak Sekretariat: +62 813 5120 2859</p>
            <p><i class="bi bi-telephone-fill me-2"></i>Kontak Pendeta: +62 812 3456 7890</p>
            <p><i class="bi bi-telephone-fill me-2"></i>Kontak Pelayan: +62 811 9876 5432</p>
            <br>
            <p><i class="bi bi-envelope-fill me-2"></i>Email Sekretariat: sekretariatbukitzaitun@gmail.com</p>
            
            <p><i class="bi bi-clock-fill me-2"></i>Konsultasi (13.00 - 19.00 WIB)</p>
             <p><i class="bi bi-geo-alt-fill me-2"></i>GPPIK Bukit Zaitun Pontianak Lantai 2</p>
        </div>
